        ...
        <table border="1">
            ...
            <% 
                ...
                try {
                    ...
                    String getOrderHistoryQuery = "SELECT orderId, userName, userID, userAddress, userItem, userPay, orderDate FROM order_table WHERE userID=?";
                    
                    try (PreparedStatement getOrderHistoryStmt = conn.prepareStatement(getOrderHistoryQuery)) {
                        getOrderHistoryStmt.setString(1, userSessionID);

                        try (ResultSet rs = getOrderHistoryStmt.executeQuery()) {
                            while (rs.next()) {
