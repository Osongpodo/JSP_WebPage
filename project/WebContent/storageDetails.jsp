...
<head>
    <meta charset="UTF-8">
    <title>Storage Detail PAGE</title>
...
String dbPassword = "0000";
    ...
    try {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl, dbUser, dbPassword)) {
            ...
            String selectQuery = "SELECT * FROM storage_table WHERE model=?";
            try (PreparedStatement selectStatement = connection.prepareStatement(selectQuery)) {
                selectStatement.setString(1, model);
                try (ResultSet resultSet = selectStatement.executeQuery()) {
                    if (resultSet.next()) {
                        out.println("<h2>Storage 세부 정보 : " + model + "</h2>");
                        ...
                        out.println("<p>용량: " + resultSet.getString("capacity") + "</p>");
                        out.println("<p>NAND: " + resultSet.getString("NAND") + "</p>");
                        out.println("<p>인터페이스: " + resultSet.getString("interface") + "</p>");
                        out.println("<p>폼 팩터: " + resultSet.getString("form_factor") + "</p>");
                        out.println("<p>DRAM: " + resultSet.getString("DRAM") + "</p>");
                        out.println("<p>읽기 성능: " + resultSet.getString("read_performance") + "</p>");
                        out.println("<p>쓰기 성능: " + resultSet.getString("write_performance") + "</p>");
                        out.println("<p>4K 읽기: " + resultSet.getString("4K_read") + "</p>");
                        out.println("<p>4K 쓰기: " + resultSet.getString("4K_write") + "</p>");
                        out.println("<p>지속적인 쓰기: " + resultSet.getString("persistent_write") + "</p>");
                        out.println("<p>최대 온도: " + resultSet.getString("maximum_temperature") + "</p>");
                        ...
                        Cookie cookie = new Cookie(cookieName, "storage");
                        cookie.setPath("/");
                        ...
                        <a href="storage.jsp" style="color: black;">선택화면으로</a>
