...
<head>
    <meta charset="UTF-8">
    <title>Motherboard Detail PAGE</title>
...
String dbPassword = "0000";
    ...
    try {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl, dbUser, dbPassword)) {
            ...
            String selectQuery = "SELECT * FROM motherboard_table WHERE model=?";
            try (PreparedStatement selectStatement = connection.prepareStatement(selectQuery)) {
                selectStatement.setString(1, model);
                try (ResultSet resultSet = selectStatement.executeQuery()) {
                    if (resultSet.next()) {
                        out.println("<h2>Motherboard 세부 정보 : " + model + "</h2>");
                        ...
                        out.println("<p>소켓: " + resultSet.getString("socket") + "</p>");
                        out.println("<p>칩셋: " + resultSet.getString("chipset") + "</p>");
                        out.println("<p>폼 팩터: " + resultSet.getString("form_factor") + "</p>");
                        out.println("<p>메모리: " + resultSet.getString("memory") + "</p>");
                        out.println("<p>DIMM: " + resultSet.getString("DIMM") + "</p>");
                        out.println("<p>M.2: " + resultSet.getString("M_2") + "</p>");
                        out.println("<p>SATA: " + resultSet.getString("SATA") + "</p>");
                        out.println("<p>전원 공급: " + resultSet.getString("power_supply") + "</p>");
                        out.println("<p>전원 제한: " + resultSet.getString("power_limit") + "</p>");
                        out.println("<p>전원 공급 온도: " + resultSet.getString("power_supply_temperature") + "</p>");
                        ...
                        Cookie cookie = new Cookie(cookieName, "motherboard");
                        cookie.setPath("/");
                        ...
                        <a href="motherboard.jsp" style="color: black;">선택화면으로</a>
